        ...
        <div class="card white col s12">
            <div class="card-content">
                ...
                <div class="col s12 m12 l6 left">
                    ...
                    <p>Telefone: (73)3531-4009</p>
                    <p>Email: casadoagricultor1990@hotmail.com</p>
                </div>
                ...
                <div class="col s12 m12 l6 right">
                    ...
                    <div class="input-field">
                        ...
                        <textarea id="message" name="message" required class="materialize-textarea" data-length="255""><?php echo $message; ?></textarea>
